...
if __name__ == "__main__":
    ...
    Funciones.subir_pala(70)                                #sube pala para que no se caigan las pelotas
    Funciones.turn_to_angle(90)                             #gira 90 a la derecha
    Funciones.mover_con_pid_sin_reiniciar(370,-90)          #avanza a dejar las pelotas
    Funciones.turn_to_angle(90)                             #gira 0 a la izquerda
    Funciones.mover_con_pid_sin_reiniciar(15,0)             #avanza para despues abrir caja
    Funciones.bajar_brazo(95)                               #baja el brazo
    ...
    Funciones.mover_con_pid_sin_reiniciar(-900,-180)        #retrocede para buscar los bloques
    Funciones.bajar_pala(220)                               #baja pala para juntar bloques
    Funciones.mover_con_pid_sin_reiniciar(93*camara.box_roja,-90)#avanza hasta box rojo
    Funciones.giro_izq(-180)                                #gira para agarral el box rojo
    Funciones.mover_con_pid_sin_reiniciar(70)               #avanza para egarral el rojo
